...
function ddbasic_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  // Unset CSS
  $form['ddbasic-settings']['cssexcludes'] = array(
  '#type' => 'fieldset',
  '#title' => t('Unset CSS'),
  '#collapsible' => TRUE,
  '#collapsed' => FALSE,
  ...
  $form['ddbasic-settings']['cssexcludes']['enable_exclude_css'] = array(
    '#type' => 'checkbox',
  ...
  if (($enable_exclude_css && $form_state['values']['enable_exclude_css'] == 1) || (!$enable_exclude_css && $form['ddbasic-settings']['cssexcludes']['enable_exclude_css']['#default_value'] == 1)) {
