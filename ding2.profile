...
/**
 * Configuring customerror module.
 */
function ding2_customerror_settings() {
  if (module_exists('customerror')) {
    ...
    $content_403_authenticated = '<h3>' . t('access denied: insufficient permissions') . '</h3><p>' . t('access denied: insufficient permissions') . '</p>';
    variable_set('customerror_403_authenticated_title', t('access denied: insufficient permissions'));
