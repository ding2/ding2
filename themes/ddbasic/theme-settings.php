...
function ddbasic_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  // Disable overlay on Ding news teasers.
  ...
  // Disable overlay on Ding news teasers.
  $form['ddbasic_settings']['ding_tabroll_overlay'] = array(
    '#type' => 'fieldset',
    '#title' => t('Ding tabroll overlay'),
  );
  $form['ddbasic_settings']['ding_tabroll_overlay']['ding_tabroll_disable_overlay'] = array(
    '#type' => 'checkbox',
    '#title' => t('Disable overlay'),
    '#description' => t('Disable gradient overlay with text on Ding tabroll teasers'),
    '#default_value' => theme_get_setting('ding_tabroll_disable_overlay'),
  );
