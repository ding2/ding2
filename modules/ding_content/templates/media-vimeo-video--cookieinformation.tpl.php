...
<div class="<?php print $classes; ?> media-vimeo-<?php print $id; ?>">
  ...
  <iframe class="media-vimeo-player" data-category-consent="cookie_cat_marketing" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="" data-consent-src="<?php print $url; ?>" frameborder="0" allowfullscreen><?php print $alternative_content; ?></iframe>
</div>
