    ...
    <div class="col-12 center">
      ...
      <div class="js-confirmation" style="display:none">
        ...
        <?php else : ?>
          ...
          <p><a class="btn btn-primary disabled" id="js-upload-another" href="/admin/config/ting/ddb_cover_upload"><?php print t('Upload another'); ?></a></p>
        <?php endif; ?>
      </div>
      ...
      <p>
        <a class="btn btn-primary disabled" id="js-upload-another" href="/admin/config/ting/ddb_cover_upload"><?php print t('Upload another'); ?></a>
      </p>
    </div>
  </div>
