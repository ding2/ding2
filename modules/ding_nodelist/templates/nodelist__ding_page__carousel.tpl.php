...
$image = '';
if (!empty($item->image)) {
  $image = '<div class="page-image" style="background-image:url(' . $item->image . ');"></div>';
}
...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php print $image; ?>
  <div class="page-time">
    <div class="page-day"><?php print format_date($item->timestamp, 'custom', 'D', $item->timezone); ?></div>
    <div class="page-date"><?php print format_date($item->timestamp, 'custom', 'd', $item->timezone); ?></div>
    <div class="page-month"><?php print format_date($item->timestamp, 'custom', 'M', $item->timezone); ?></div>
  </div>
